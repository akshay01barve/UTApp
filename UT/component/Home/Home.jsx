...
const Home = () => {
  ...
  return (
    <View className="pb-[300px]">
      <View className="p-2 bg-fuchsia-600">
        <Text className="font-mono font-bold  text-xl">If You Focus You Will Learn, Without Focusing you can't learn, if You learn You can grow, Without learning you can't grow, if you Grow you can enjoy, without growing you shouldn't enjoy Reapet</Text>
      </View>
      <View>
